...
minikube start --driver=hyperv --container-runtime=cri-o --cpus 4 --memory $(((((Get-CimInstance Win32_PhysicalMemory | Measure-Object -Property capacity -Sum).sum - 8gb) /1mb), 1800 | Measure -Max).Maximum)
